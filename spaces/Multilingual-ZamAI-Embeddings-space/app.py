...
# Model configuration
MODEL_NAME = "tasal9/Multilingual-ZamAI-Embeddings"
...
with gr.Blocks(title="Multilingual-ZamAI-Embeddings Space") as iface:
    gr.Markdown(f"# Multilingual-ZamAI-Embeddings")
